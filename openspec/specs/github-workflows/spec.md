...
Define el comportamiento de los workflows de GitHub Actions: CI de tests multiplataforma y publicación a npm con provenance firmada, incluyendo las verificaciones previas que garantizan que solo se publica desde commits con metadatos válidos.
